...
#t.test(ZIP_PA_DIS$scaled_sci ~ ZIP_PA_DIS$correlation)
...
#df_sdoh_sci_fr <- df_sdoh_sci_fr%>% sort('Count', decreasing =)
...
***ADD LASSO AND RIDGE FOR SELECTED PREDICTORS ***
...
```
20 predictors minimize our MSE to .0008530994.
...
```
The ridge MSE is 0.0008384644, which is actually slightly higher than our forward selection model.
...
```
The MSE with Lasso is slightly lower than the MSE we got from forward selection: 0.0008187119
